				...
				<div class="container">
					<div class="row align-items-center justify-content-lg-between">
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-delay=".1s">
							<h1 class="page_title mb-0">Banners and Stickers</h1>
						</div>

						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRight" data-wow-delay=".1s">
							<ul class="breadcrumb_nav ul_li_right clearfix">
								<li><a href="/">Home</a></li>
								<li>Banners and Stickers</li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-8 col-md-8">
							<div class="details_content">
								<div class="wow fadeInUp2" data-wow-delay=".1s">
									<h2 class="item_title mb_15">Banners and Stickers</h2>
								</div>
							...
							<aside class="sidebar_section clearfix">
								<div class="widget wow fadeInUp2 sb_service_category" data-wow-delay=".1s">
									...
									<ul class="ul_li_block clearfix">
										<li><i class="fa fa-chevron-right"></i> Vinyl Stickers</li>
										<li><i class="fa fa-chevron-right"></i> Contravision Stickers</li>
										<li><i class="fa fa-chevron-right"></i> Froast Stickers</li>
										<li><i class="fa fa-chevron-right"></i> Blockout Banners</li>
										<li><i class="fa fa-chevron-right"></i> Backlight Banners</li>
									</ul>
								</div>								
							</aside>
						</div>
